...
export default function Footer() {
    return (
        <footer style={{ backgroundColor: '#0a1628', color: 'white', fontFamily: 'system-ui, sans-serif' }}>
            ...
            {/* Chat Widget */}
            <div style={{ position: 'fixed', bottom: '2rem', right: '2rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <div style={{ backgroundColor: 'white', padding: '0.75rem 1rem', borderRadius: '50px', boxShadow: '0 4px 15px rgba(0,0,0,0.15)', display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.9rem', color: '#333' }}>
                    Chat with us 👋
                </div>
                <button style={{ width: '50px', height: '50px', borderRadius: '50%', backgroundColor: '#f59e0b', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 15px rgba(0,0,0,0.2)' }}>
