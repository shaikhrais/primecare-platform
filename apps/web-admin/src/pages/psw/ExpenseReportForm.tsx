    ...
    return (
        <div style={{ maxWidth: '700px', margin: '0 auto', padding: '2rem' }} data-cy="form.expense.page">
            ...
            <div style={{ marginBottom: '2rem' }}>
                <h2 style={{ fontSize: '1.75rem', fontWeight: 'bold', color: '#111827' }} data-cy="form.expense.header">Expense Reimbursement Claim</h2>
                <p style={{ color: '#6b7280' }}>Submit travel, meal, or medical supply expenses for reimbursement.</p>
            </div>
